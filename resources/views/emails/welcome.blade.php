        ...
        <table width="100%" cellpadding="0" cellspacing="0" bgcolor="FFFFFF"
            ...
            <tr>
                <td style="padding: 20px; text-align: center;" class="bg-grd">
                    <h1 style="color: #ffffff" class="text-white font-raleway uppercase font-bold">Welcome !</h1>
                </td>
            </tr>
            <tr class="" style="background-color: #ffffff;">
                <td class="p-5">
                    ...
                    <p class="font-raleway leading-6 text-center">
                        {{-- {{$msg}} --}}Your account has been created <br> and you can now log in to the post bahamas
                        <hr>
